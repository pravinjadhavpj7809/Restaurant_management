...
//            else
//            {
//                Product product = await products.GetByIdAsync(id, new QueryOption<Product>
//                {
...
//                else
//                {
//                    var existingProduct = await products.GetByIdAsync(product.ProductId, new QueryOption<Product> { Includes = "ProductIngredients" });
...
//                    foreach(int id in ingredientIds)
//                    {
//                        existingProduct.ProductIngredients?.Add(new ProductIngredients { IngredientId = id, ProductId = product.ProductId });
//                    }
